...
//    }
    ...
    /**
     * Returns an array of ints representing the indexes of the 'n' minimum values in the passed-in array.
     * @param array
     * @param n
     * @return
     */
    public static <T extends Comparable<T>> int[] indexOfMinimums(T[] array, int n) {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            for (int m = 0; m < n; m++) {
                if (minimums[m] >= array.length) {
                    shiftArrayRight(minimums, m);
                    minimums[m] = i;
                    break;
                }
                if (array[i].compareTo(array[minimums[m]]) < 0) {
                    shiftArrayRight(minimums, m);
                    minimums[m] = i;
                    break;
                }
    ...
    /**
     * Shifts the contents of an array to the right, starting at index.
     * @param array
     * @param index
     */
    public static void shiftArrayRight(int[] array, int index) {
